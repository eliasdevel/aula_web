...
<c:forEach items = "${products}"  var = "product">
    <div class="product col-md-12 col-lg-12 center-block" id="product_<c:out value = "${product.getId()}"/>">
        ...
        <a class="product-link" href="?p=Productp&id=<c:out value = "${product.getId()}"/>"><img class="product img-responsive"   src="data:image/png;base64, <c:out value = "${product.getImages()[0].getBase64Data()}"/>" ></a>
    </div>
</c:forEach>
