...
<c:forEach items = "${products}"  var = "product">
    <div class="product col-md-12 col-lg-12 center-block" id="product_<c:out value = "${product.getId()}"/>">
        ...
        <a class="product-link" href="?p=Product&id=<c:out value = "${product.getImages()[0].getId()}"/>"><img class="product"  width="200px" src="data:image/png;base64, <c:out value = "${product.getImages()[0].getBase64Data()}"/>" ></a>
    </div>
</c:forEach>
