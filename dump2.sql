...
--
-- Name: addresses_id_sequence; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.addresses_id_sequence
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.addresses_id_sequence OWNER TO postgres;
...
--
-- Name: images_id_sequence; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.images_id_sequence
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.images_id_sequence OWNER TO postgres;
...
CREATE TABLE public.images (
    id integer DEFAULT nextval('public.images_id_sequence'::regclass) NOT NULL,
    name character varying(45),
...
--
-- Name: products_id_sequence; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.products_id_sequence
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.products_id_sequence OWNER TO postgres;
...
CREATE TABLE public.products (
    id integer DEFAULT nextval('public.products_id_sequence'::regclass) NOT NULL,
    description character varying(200),
    name character varying(100),
    price numeric,
...
2	qwseqwe	123123333	\N	2
4	qwseqwe	123123333	\N	2
6	qwseqwe	123123333	\N	2
\.


--
-- Name: addresses_id_sequence; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.addresses_id_sequence', 6, true);
...
SELECT pg_catalog.setval('public.categories_id_sequence', 1, true);
...
SELECT pg_catalog.setval('public.citys_id_sequence', 2, true);
...
COPY public.images (id, name, label, product_id, base64data) FROM stdin;
\.


--
-- Name: images_id_sequence; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.images_id_sequence', 1, true);
...
--
-- Name: products_id_sequence; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.products_id_sequence', 4, true);
...
4	teste1212	\N	elias.muller1@GMAIL.COM	R	03033083030	2
\.
...
SELECT pg_catalog.setval('public.users_id_sequence', 1, false);
